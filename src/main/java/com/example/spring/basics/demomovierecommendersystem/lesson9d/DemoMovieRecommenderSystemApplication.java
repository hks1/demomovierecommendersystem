package com.example.spring.basics.demomovierecommendersystem.lesson9d;
...
//@ComponentScan("com.example.spring.basics.demomovierecommendersystem.lesson10")

/*
 * @ComponentScan(basePackages=
 * {"com.example.spring.basics.demomovierecommendersystem.lesson9c",
 * "com.example.spring.basics.demomovierecommendersystem.lesson10"})
 */

@ComponentScan(basePackages = "com.example.spring.basics.demomovierecommendersystem.lesson10")
@ComponentScan(includeFilters = @ComponentScan.Filter(
        type= FilterType.REGEX,
        pattern = "com.example.spring.basics.demomovierecommendersystem.lesson9d.*"))
